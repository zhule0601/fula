...
DEFAULT_APP_PROPERTY=" -Dspring.config.location=${CONF_DIR}/application.properties -Dfile.encoding=UTF-8 -Dlogging.config=${LOGBACK_FILE} -Dapp.home=${APP_HOME} -Djava.io.tmpdir=${VAR_DIR} -Dapp.bin=${BIN_DIR}"
